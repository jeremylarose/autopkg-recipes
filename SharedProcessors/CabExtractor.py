...
class CabExtractor(Processor):
    ...
    def main(self):
        ...
        cabextract_local = os.path.join(RECIPE_CACHE_DIR, 'downloads', 'cabextract')
        ...
        shutil.copyfile(cabextract, cabextract_local)

        cmd = [cabextract_local, cab_path, '-d', cab_extract_path]
